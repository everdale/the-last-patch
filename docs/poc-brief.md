...
5. **Antagonist cameo (optional but valuable).** **Boole** (the Fixer; renamed from AUTOPATCH → George → Boole, after George Boole) appears and *helpfully* offers to fix it for you / closes something you wanted left open. Plants the villain in 20 seconds.
...
- Whether to include the Boole (Fixer) cameo now or stub it.
